...
export default function SearchElementList({ location }) {
  ...
  const world_id = location.state.worldID;
            ...
            ({ loading, error, data }) => {
              if (loading) {
                ...
                return <div>Error</div>
                  ...
                  return <Jumbotron className="jumbotron default">No Elements</Jumbotron>
              } else {
