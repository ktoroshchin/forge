        ...
        <Container>
          <div className="custom-row">
            <div className="col-lg-8 mx-auto">
              ...
              <p className="lead">This is an aide to all those DM's, GM's, Author's or anyone who's into creating their own world. But is fed up with having to keep track of all their miscellaneous papers, documents, maps, etc.</p>
              <ul>
